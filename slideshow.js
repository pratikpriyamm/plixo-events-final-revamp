...
// only 10 images display in slideshow
// -----------------------------------------------------------------
// document.addEventListener("DOMContentLoaded", () => {
//     // Locate the slideshow container on the current page
//     const container = document.querySelector('.slideshow-container');
...
//         // ==========================================
//         // Grab only the last 10 images from the JSON
//         // ==========================================
//         const lastTenImages = categoryData.images.slice(-10);

//         // 3. Render the images (passing the shortened array)
//         renderSlides(container, lastTenImages, isServicePage);
